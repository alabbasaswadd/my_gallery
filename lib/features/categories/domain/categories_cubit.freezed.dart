...
class CategoriesLoaded implements CategoriesState {
  const CategoriesLoaded(final  List<CategoryListItem> categories): _categories = categories;
  

 final  List<CategoryListItem> _categories;
 List<CategoryListItem> get categories {
