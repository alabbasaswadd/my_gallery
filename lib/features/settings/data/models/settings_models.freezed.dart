...
mixin _$StorefrontSettings {
 ...
 String get brandName; String? get logo; String? get favicon; String get primaryColor; String get secondaryColor; String get accentColor; String get backgroundColor; String get surfaceColor; String get textColor; double get borderRadius; String get fontFamily; List<HeroSlide> get heroSlides; SocialLinks get social;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,brandName,logo,favicon,primaryColor,secondaryColor,accentColor,backgroundColor,surfaceColor,textColor,borderRadius,fontFamily,const DeepCollectionEquality().hash(heroSlides),social);

@override
String toString() {
  return 'StorefrontSettings(brandName: $brandName, logo: $logo, favicon: $favicon, primaryColor: $primaryColor, secondaryColor: $secondaryColor, accentColor: $accentColor, backgroundColor: $backgroundColor, surfaceColor: $surfaceColor, textColor: $textColor, borderRadius: $borderRadius, fontFamily: $fontFamily, heroSlides: $heroSlides, social: $social)';
}
...
@useResult
$Res call({
 String brandName, String? logo, String? favicon, String primaryColor, String secondaryColor, String accentColor, String backgroundColor, String surfaceColor, String textColor, double borderRadius, String fontFamily, List<HeroSlide> heroSlides, SocialLinks social
});
...
/// Create a copy of StorefrontSettings
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? brandName = null,Object? logo = freezed,Object? favicon = freezed,Object? primaryColor = null,Object? secondaryColor = null,Object? accentColor = null,Object? backgroundColor = null,Object? surfaceColor = null,Object? textColor = null,Object? borderRadius = null,Object? fontFamily = null,Object? heroSlides = null,Object? social = null,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String brandName,  String? logo,  String? favicon,  String primaryColor,  String secondaryColor,  String accentColor,  String backgroundColor,  String surfaceColor,  String textColor,  double borderRadius,  String fontFamily,  List<HeroSlide> heroSlides,  SocialLinks social)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _StorefrontSettings() when $default != null:
return $default(_that.brandName,_that.logo,_that.favicon,_that.primaryColor,_that.secondaryColor,_that.accentColor,_that.backgroundColor,_that.surfaceColor,_that.textColor,_that.borderRadius,_that.fontFamily,_that.heroSlides,_that.social);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String brandName,  String? logo,  String? favicon,  String primaryColor,  String secondaryColor,  String accentColor,  String backgroundColor,  String surfaceColor,  String textColor,  double borderRadius,  String fontFamily,  List<HeroSlide> heroSlides,  SocialLinks social)  $default,) {final _that = this;
switch (_that) {
case _StorefrontSettings():
return $default(_that.brandName,_that.logo,_that.favicon,_that.primaryColor,_that.secondaryColor,_that.accentColor,_that.backgroundColor,_that.surfaceColor,_that.textColor,_that.borderRadius,_that.fontFamily,_that.heroSlides,_that.social);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String brandName,  String? logo,  String? favicon,  String primaryColor,  String secondaryColor,  String accentColor,  String backgroundColor,  String surfaceColor,  String textColor,  double borderRadius,  String fontFamily,  List<HeroSlide> heroSlides,  SocialLinks social)?  $default,) {final _that = this;
switch (_that) {
case _StorefrontSettings() when $default != null:
return $default(_that.brandName,_that.logo,_that.favicon,_that.primaryColor,_that.secondaryColor,_that.accentColor,_that.backgroundColor,_that.surfaceColor,_that.textColor,_that.borderRadius,_that.fontFamily,_that.heroSlides,_that.social);case _:
  return null;
...
class _StorefrontSettings implements StorefrontSettings {
  const _StorefrontSettings({required this.brandName, this.logo, this.favicon, this.primaryColor = '#C0446A', this.secondaryColor = '#3C2A34', this.accentColor = '#D4A02A', this.backgroundColor = '#FBF7F4', this.surfaceColor = '#FFFFFF', this.textColor = '#2A2024', this.borderRadius = 16.0, this.fontFamily = 'Tajawal', final  List<HeroSlide> heroSlides = const [], this.social = const SocialLinks()}): _heroSlides = heroSlides;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,brandName,logo,favicon,primaryColor,secondaryColor,accentColor,backgroundColor,surfaceColor,textColor,borderRadius,fontFamily,const DeepCollectionEquality().hash(_heroSlides),social);
...
/// Create a copy of StorefrontSettings
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? brandName = null,Object? logo = freezed,Object? favicon = freezed,Object? primaryColor = null,Object? secondaryColor = null,Object? accentColor = null,Object? backgroundColor = null,Object? surfaceColor = null,Object? textColor = null,Object? borderRadius = null,Object? fontFamily = null,Object? heroSlides = null,Object? social = null,}) {
